...
<head>
	...
	<title>labopaes -  @yield('title')</title>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<a class="see-all" href="javascript:void(0);">Ver todad las notificaciones<i class="fa fa-angle-right"></i> </a>
								</li>
							</ul>
						</li>
						{{-- <li class="nav-item dropdown hidden-caret">
								...
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<form method="POST" action="{{ route('logout') }}">
											@csrf											
											<button class="dropdown-item" action="{{route('logout')}}">Cerrar sesión</button>
										</form>
									</li>
								</div>
							</ul>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						@can('estadofinanciero.balancegeneral')	
						<li class="nav-item">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <nav class="pull-left">
                    <ul class="nav">
                        <li class="nav-item">
                            Laboratorio de Patología Especializada 
                        </li>
                        {{-- <li class="nav-item">
                ...
                <div class="copyright ml-auto">
                    © 2020- Todos los derechos reservados™ , creado con <i class="fa fa-heart heart text-danger"></i> por <a href="https://endprog.com/">endprog.com</a>
                </div>				
            </div>
        </footer>
    </div>
